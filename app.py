...
title = st.text_input('Search input based on option', 'dil chahta hai ')
SongName = st.text_input('Song name/Name you would like to display', 'Dil Chahta Hai!')
